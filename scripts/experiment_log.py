...
def capture_dialectical_state(
    ...
    *,
    ...
    if stage == "plan":
        ...
        plan["knowledge_anchor_experiment_id"] = state.get("knowledge_anchor_experiment_id")
        plan["knowledge_opposing_experiment_id"] = state.get("knowledge_opposing_experiment_id")
        plan["knowledge_selection_reason"] = state.get("knowledge_selection_reason")
        plan["knowledge_transcendent_prediction"] = state.get("knowledge_transcendent_prediction")
